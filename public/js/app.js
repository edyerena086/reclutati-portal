...
Vue.component('candidate-registration-form', __webpack_require__(11));
    ...
    methods: {
        sendForm: function sendForm(e) {
            ...
            if (this.checkForm()) {
                ...
                this.$http.post(this.baseUrl + '/candidate/account/store', data).then(function (response) {}).catch(function (error) {
