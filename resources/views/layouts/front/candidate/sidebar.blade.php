						...
						<div class="category-content">
							<div class="media">
								...
								<div class="media-body">
									<span class="media-heading text-semibold">{{ ucwords(Auth::user()->name.' '.Auth::user()->candidate->last_name) }}</span>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href="{{ url('candidate/dashboard/curriculum') }}"><i class="icon-list-unordered"></i> <span>Mi Currículum</span></a>
								</li>
								<li>
									<a href="{{ url('candidate/dashboard/job-offers') }}"><i class="icon-file-text3"></i> <span>Ofertas Guardadas</span></a>
								</li>
								<li><a href="{{ url('candidate/dashboard/profile') }}"><i class="icon-user"></i> <span>Mi Perfil</span></a></li>
